    ...
    <section className="about">
      <div className="about__container">
        ...
        <article className="about__article">
          <p className="about__text">Привет, меня зовут Максим, я являюсь руководителем стартап-проекта «SUCCESSEARCH». Обучение по программе «Веб-разработчик» Яндекс.Практикума помогло мне  начать эффективно применять современные технологии разработки.</p>
